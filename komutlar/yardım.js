...
exports.run = async (client, message, args) => {
  ...
  var embed = new Discord.RichEmbed()
    .setColor("RANDOM")
    .setAuthor("Kasap Bot List", client.user.avatarURL)
    .addField(
      "Sistemin amacı nedir? Sistem ne işe yaramaktadır?",
      "Gerekli bilgiyi [buraya tıklayarak](https://kasap-botlist.glitch.me/hakkimizda) görebilirsiniz."
    )
    .addField(
      "Bot nasıl ekleyeceğim?",
      "[Buraya tıklayarak](https://kasap-botlist.glitch.me/botekle) bot ekleyebileceğiniz yere ışınlanabilirsiniz."
    )
    .addField(
      "Sistemdeki tüm botları nereden görebilirim?",
      "[Buraya tıklayarak](https://kasap-botlist.glitch.me/botlar) görebilirsiniz."
    )
    .addField(
      "Sertifika ne işe yarar? Nasıl alınır?",
      "[Buraya tıklayarak](https://kasap-botlist.glitch.me/sertifika) görebilirsiniz."
    )
    .addField(
